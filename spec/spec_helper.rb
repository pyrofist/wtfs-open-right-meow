...
fake_nearby_response = <<-FAKE_NEARBY_RESPONSE
{
   "html_attributions" : [],
   "results" : [
      {
...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    with(
      ...
      status: 200,
      body: fake_lookup_response,
      headers: {}
    )

    stub_request(:get, "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=").
    with(
      headers: { 'Accept'=>'*/*',
        'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
        'Host'=>'maps.googleapis.com',
